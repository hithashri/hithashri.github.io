...
<div class="card-grid">
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/recommendation-system-architecture.png" alt="Breakdown Recommendation System placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/cycle-time-model-architecture.png" alt="Cycle Time Reduction placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/leadership-review-chatbot-architecture.png" alt="Leadership Review Chatbot placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/fmr-data-pipeline-architecture.png" alt="FMR OCR Data Pipeline placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/secure-ocr-tool-architecture.png" alt="Secure On-Prem OCR Tool placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/llm-validation-framework-architecture.png" alt="LLM Validation Framework placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/federated-learning-privacy-architecture.png" alt="Federated Learning Privacy placeholder diagram">
  ...
  <div class="card">
    ...
    <img class="diagram-preview" src="assets/diagrams/helmet-detection-architecture.png" alt="Helmet Detection System placeholder diagram">
...
```markdown
![Breakdown Recommendation Architecture](assets/diagrams/recommendation-system-architecture.png)
```
